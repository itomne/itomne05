        ...
        if submitted:
            ...
            data = {
                ...
                "messages":[
                    ...
                    {"role": "system", "content": "制約条件:あなたは相手との会話の最後に問題提起力を評価する。相手の問題提起力を100点満点で点数を付ける。"},
                    ...
                    {"role": "system", "content": "制約条件:それでは質問です。あなたが影響を受けた作品もしくは表現物について解釈し直してみましょう。アーティスト（つくり手）がどのような世界を表現しようとしていると思いますか？たとえば世の中へ●●について提起しようとしている、●●をイメージしている、●●を表現した・・・など感じたことを述べてください。"},
                    {"role": "system", "content": "制約条件:それでは質問です。作品に対して感じたことと、あなた自身が日ごろ考えている問題意識になにか共通するものはあるでしょうか？"},
